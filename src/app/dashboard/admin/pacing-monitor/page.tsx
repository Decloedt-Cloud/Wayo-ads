...
export default function PacingMonitorPage() {
  ...
  async function fetchPacingData() {
    ...
    try {
      const res = await fetch('/api/admin/pacing');
    ...
    return (
      <div className="container mx-auto py-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold">Campaign Pacing Monitor</h1>
        </div>
  ...
  return (
    <div className="container mx-auto py-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Monitor campaign burn rates and delivery progress
      ...
      <Card>
        <CardHeader>
          <CardTitle>Campaign Pacing Status</CardTitle>
          <CardDescription>
            Real-time pacing status for all active campaigns with pacing enabled
          </CardDescription>
        </CardHeader>
        <CardContent>
          {pacingData.length === 0 ? (
                ...
                {pacingData.map((campaign) => (
                  <TableRow key={campaign.campaignId}>
                    <TableCell className="font-medium">
                      <div>{campaign.campaignTitle || campaign.campaignId}</div>
                      <div className="text-xs text-muted-foreground">
                        {campaign.advertiserName || 'Unknown Advertiser'}
                      </div>
                    </TableCell>
