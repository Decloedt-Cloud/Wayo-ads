...
export default function AdvertiserBusinessInformationPage() {
  ...
  const checkPayoutReadiness = (data: any) => {
    ...
    if (data.businessType === BusinessType.REGISTERED_COMPANY) {
      ...
      setPayoutReady(
        !!(data.addressLine1 && data.city && data.postalCode && data.countryCode),
      );
    } else {
      setPayoutReady(true);
    }
    ...
    <div className="container max-w-4xl py-10 space-y-8">
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold tracking-tight">Advertiser Legal & Business Information</h1>
          <p className="text-muted-foreground">
            Manage your company and billing details for invoices and compliance.
          </p>
        </div>
      </div>
      <div className="flex items-center gap-2">
      ...
      <Alert>
        ...
        <AlertDescription>
          We use this information to generate valid invoices and comply with tax and billing regulations.
          Your data is stored securely and only used for financial processing.
        </AlertDescription>
      </Alert>
            ...
            <CardContent className="space-y-6">
              ...
              {businessType === BusinessType.PERSONAL && (
                <p className="text-sm text-muted-foreground bg-slate-50 p-4 rounded-md border border-slate-100">
                  As an Individual, you do not need to provide a company name or VAT number. Billing will be
